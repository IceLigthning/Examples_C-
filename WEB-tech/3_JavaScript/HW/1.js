...
let temperature_C = parseInt(prompt("Введите первую температуру в цельсиях:"));

let temperature_F = parseInt((9 / 5) * temperature_C + 32);

alert(`Первая температура в ${temperature_C} градусов Цельсия равна первой температуре в ${temperature_F} градусов Фаренгейта.`)