...
в которой подключить файл 2.js (его тоже необходимо создать 
...
let question = prompt("Приветсвуем, кто вы?");
function greeting(value) {
    let mess;
    if(value != '') {
        mess = `Добро пожаловать, ${value}!`;
    }
    else {
        mess = `Вы не представились, приветсвия не будет!`;
    }
    alert(mess);
}
greeting(question);